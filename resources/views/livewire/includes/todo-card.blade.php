    ...
    <div wire:key="{{$todo->id}}" class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
        <div class="flex justify-between space-x-2">
            ...
            <div class="flex">
                ...
                <!-- <input type="text" placeholder="Todo.." class="bg-gray-100  text-gray-900 text-sm rounded block w-full p-2.5" value="Todo Name">
            ...
            <div class="flex items-center space-x-2">
                <button wire:click="update({{$todo['id']}})" class="text-sm text-teal-500 font-semibold rounded hover:text-yellow-300">
