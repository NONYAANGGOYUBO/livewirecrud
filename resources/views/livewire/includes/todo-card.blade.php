 <div wire:key="{{$todo->id}}" class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
        <div class="flex justify-between space-x-2">
            ...
            <div class="flex items-center space-x-2">
                <button wire:click="edit({{$todo['id']}})" class="text-sm text-teal-500 font-semibold rounded hover:text-yellow-300">
        ...
        <div class="mt-3 text-xs text-gray-700">
         ...
         @if (session('variableforupdate'))
         <span class="text-green-500 text-xs">{{session('variableforupdate')}}</span>
         @endif
 </div>
